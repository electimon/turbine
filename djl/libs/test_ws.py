...
class test_ws(object):
    ...
    def connection(self):
        ...
        self.clientSOAP = SOAPpy.SOAPProxy(
            "http://djl.jeuxlinux.fr/webservice/djl_dev_bdd_dev.php")
    ...
    def detail_jeu(self, no=1, lang=0):
        ...
        try:
            ...
            print(
                "Erreur lors de la lecture de la fiche du jeu n° %i, il n'existe probablement pas." %
                (no))
            return
        ...
        for i in range(len(detail)):
            print(str(i) + ': ' + detailjeux['item'][i]['key']
                  + ': ' + detailjeux['item'][i]['value'])
