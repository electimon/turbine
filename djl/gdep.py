...
import os, urllib, threading, socket
...
class RecupLib():
    ...
    def recup(self):
        ...
        if trouve:
            ...
            interface.info_box(i18n.traduc("La librairie n'a pas ete trouvee") + ': ' + self.nom_lib + '\n' + i18n.traduc("Merci de rapporter le probleme au developpeur."))
...
class GestionLibs(object):
    ...
    def __init__(self):
        ...
        self.serveur = variables.SERVEUR_LIBRAIRIES + "/maj_djl/libs" #Serveur pour télécharger les librairies
